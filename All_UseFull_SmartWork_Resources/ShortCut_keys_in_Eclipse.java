...
//  0. ctrl+A (Select All the Items), delete(Backspace), fn+11 --> TestExecution, fn+12 ---> Inspect, Shift+<,> --- To select up to,
//     Cntrl+m -- To minimize & Maximize, Cntrl++ or Cntl--- (To increase or Decrease Font Size), Shift+Ctrl+ y,x(To UpperCase to LowerCase)
